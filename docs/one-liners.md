...
```bash
sudo curl -o /etc/pacman.d/mirrorlist 'https://archlinux.org/mirrorlist/?country=US&protocol=https&ip_version=5&use_mirror_status=on'
```
...
`sudo fuser -vm /dev/sdb2` `sudo fuser -vm /tardis`

_Force-kill them_: `sudo fuser -km /dev/sdb2`
...
Add to /etc/fstab: `UUID=9096e7c4-5ca8-4d9c-a431-72497931f44d / ext4 rw,noatime,discard 0 1`
