...
# Filename: ~/.dotfiles/tools/colors/colorscheme-set.sh
# ~/.dotfiles/colors/tools/colorscheme-set.sh
...
# Define paths
colorscheme_file="$HOME/.dotfiles/tools/colors/list/$colorscheme_profile"
active_file="$HOME/.dotfiles/tools/colors/active/active-colorscheme.sh"
