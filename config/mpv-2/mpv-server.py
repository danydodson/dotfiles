...
def missing_bin(bin_name):
    print("======================")
    print(f"ERROR: {bin_name.upper()} does not appear to be installed correctly! "
          f"Please ensure you can launch '{bin_name}' in the terminal.")
    print("======================")
