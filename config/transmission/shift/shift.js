...
const sessionFields = {
  ...
  "peer-port": {
    action: function (row, keyCell) { // Actions return true if handling should continue.
    ...
    const p = Object.entries({
      "popupTrackerUpdate": function (e) {
        ...
        switch (globals.action) {
          case "update":
            fixTorrents({
              ids: [torrent.id], trackerList: trackerArea.value.match(trackerRegExp).filter(function (v, i, a) {
  ...
  if (globals.version < 17) {
    ...
    fixTorrents({ ids: ids, trackerReplace: replace }, function (response) {
      ...
      ids.shiftEach(fetchTrackers.curry(function (torrent, _next) {
        ...
        fixTorrents({
          ids: [torrent.id], trackerReplace: trackers.each(function (tracker) {
...
function showShiftTable() {
  ...
  getTable("shiftTable", globals.content, shiftColumns, undefined, function (t) {
    ...
    $(t.footer).down("button.apply").insert({
      after: rB("Revert", function (e) {
        e && e.stop();
        doRequest({
          url: "shift.json", evalJSON: "force", method: "get", onSuccess: function (response) {
...
function renderPage() {
  ...
  const d = globals.dialogs = {
    ...
    add: {
      file: rI("", {
        type: "file", multiple: "multiple", change: function (e) {
          _file(e);
  ...
  doRequest({
    url: "shift.json", evalJSON: "force", method: "get", onSuccess: function (response) {
      ...
      if (!isEmpty(globals.shift.settings.mimeTypeIconTemplate)) {
        doRequest({
          url: "mime.types", method: "get", onSuccess: function (response) {
            var m;
