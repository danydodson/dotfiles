...
# Define paths
colorscheme_file="$HOME/.dotfiles/colors/list/$colorscheme_profile"
active_file="$HOME/.dotfiles/colors/active/active-colorscheme.sh"
...
generate_ghostty_config() {
  ghostty_conf_file="$HOME/.dotfiles/config/ghostty/themes/ghostty-theme"

  cat >"$ghostty_conf_file" <<EOF
background = $dots_color10
foreground = $dots_color14

cursor-color = $dots_color24

# black
palette = 0=$dots_color10
palette = 8=$dots_color08
# red
palette = 1=$dots_color11
palette = 9=$dots_color11
# green
palette = 2=$dots_color02
palette = 10=$dots_color02
# yellow
palette = 3=$dots_color05
palette = 11=$dots_color05
# blue
palette = 4=$dots_color04
palette = 12=$dots_color04
# purple
palette = 5=$dots_color01
palette = 13=$dots_color01
# aqua
palette = 6=$dots_color03
palette = 14=$dots_color03
# white
palette = 7=$dots_color14
palette = 15=$dots_color14
EOF
...
#   btop_conf_file="$HOME/.dotfiles/config/btop/themes/btop-theme.theme"
...
# foreground            $dots_color14
# background            $dots_color07
# selection_foreground  $dots_color14
# selection_background   $dots_color16
# url_color             $dots_color03
# # black
# color0                $dots_color10
# color8                $dots_color08
# # red
...
# # green
# color2                $dots_color02
# color10               $dots_color02
# # yellow
# color3                $dots_color05
# color11               $dots_color05
# # blue
# color4                $dots_color04
# color12               $dots_color04
# # magenta
# color5                $dots_color01
# color13               $dots_color01
# # cyan
# color6                $dots_color03
# color14               $dots_color03
# # white
# color7                $dots_color14
# color15               $dots_color14
# # Cursor colors
# cursor                $dots_color24
# cursor_text_color     $dots_color24
# # Tab bar colors
# active_tab_foreground  $dots_color10
# active_tab_background   $dots_color02
# inactive_tab_foreground $dots_color03
# inactive_tab_background $dots_color10
# # Marks
# mark1_foreground      $dots_color10
# mark1_background      $dots_color11
# # Splits/Windows
# active_border_color   $dots_color04
# inactive_border_color  $dots_color10
# EOF
...
#   starship_conf_file="$HOME/.dotfiles/config/starship/active-config.toml"
...
if [ "$UPDATED" = true ]; then
  ...
  # Set the tmux colors
  # $HOME/.dotfiles/config/tmux/tools/linkarzu/set_tmux_colors.sh
  ...
  generate_ghostty_config
  # osascript $HOME/.dotfiles/config/ghostty/reload-config.scpt
